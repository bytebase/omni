...
func NodeTagName(tag NodeTag) string {
	...
	case T_UnloadStmt:
		return "UnloadStmt"
	case T_RedshiftShowStmt:
		return "RedshiftShowStmt"
	case T_RedshiftDescStmt:
		return "RedshiftDescStmt"
	case T_RedshiftObjectStmt:
		return "RedshiftObjectStmt"
	case T_CommentStmt:
		return "CommentStmt"
	case T_SecLabelStmt:
		return "SecLabelStmt"
