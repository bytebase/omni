...
func TestDockerEndpointCandidatesPreferExplicitHost(t *testing.T) {
...
func TestDockerEndpointCandidatesIncludeDefaultSockets(t *testing.T) {
...
func TestParseDockerHostEndpoint(t *testing.T) {
	tests := []struct {
		name string
		host string
		want dockerEndpoint
