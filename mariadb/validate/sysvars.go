...
// validator to implement sp_head::find_variable's fallback rule: when a
// bare SET target isn't a declared local/parameter, MySQL falls back to
// treating it as a session system variable before failing.
