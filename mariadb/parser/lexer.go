...
const (
	...
	kwWEIGHT_STRING
	kwZONE
	kwGET_MASTER_PUBLIC_KEY
	kwMASTER_AUTO_POSITION
	kwMASTER_BIND
	kwMASTER_COMPRESSION_ALGORITHMS
	kwMASTER_CONNECT_RETRY
	kwMASTER_DELAY
	kwMASTER_HEARTBEAT_PERIOD
	kwMASTER_HOST
	kwMASTER_LOG_FILE
	kwMASTER_LOG_POS
	kwMASTER_PASSWORD
	kwMASTER_PORT
	kwMASTER_PUBLIC_KEY_PATH
	kwMASTER_RETRY_COUNT
	kwMASTER_SSL
	kwMASTER_SSL_CA
	kwMASTER_SSL_CAPATH
	kwMASTER_SSL_CERT
	kwMASTER_SSL_CIPHER
	kwMASTER_SSL_CRL
	kwMASTER_SSL_CRLPATH
	kwMASTER_SSL_KEY
	kwMASTER_SSL_VERIFY_SERVER_CERT
	kwMASTER_TLS_CIPHERSUITES
