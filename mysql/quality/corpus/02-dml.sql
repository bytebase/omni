...
-- @valid: false
-- @source: docs/scenarios/mysql/SCENARIOS-mysql-strict.md section 2.3
DELETE WHERE id = 1
...
-- @valid: false
-- @source: docs/scenarios/mysql/SCENARIOS-mysql-strict.md section 2.5
UPDATE t WHERE id = 1
...
-- @valid: false
-- @source: docs/scenarios/mysql/SCENARIOS-mysql-strict.md section 2.4
