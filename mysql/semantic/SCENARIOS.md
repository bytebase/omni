...
```
[x] PARTITION BY RANGE (col)
[x] PARTITION BY RANGE COLUMNS (col)
[x] PARTITION BY LIST (col)
[x] PARTITION BY HASH (col)
[x] PARTITION BY KEY (col)
[x] LINEAR HASH
[x] SUBPARTITION
[x] SHOW CREATE TABLE output for partitioned tables
[x] ALTER TABLE ADD PARTITION
[x] ALTER TABLE DROP PARTITION
[x] ALTER TABLE REORGANIZE PARTITION
[x] ALTER TABLE TRUNCATE PARTITION
[x] ALTER TABLE COALESCE PARTITION
[x] ALTER TABLE EXCHANGE PARTITION
```
