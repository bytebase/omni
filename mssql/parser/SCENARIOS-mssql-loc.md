...
- [x] Nodes that never get explicit Loc assignment — all Loc creation sites now use explicit Start/End values (never rely on Go zero-value), consistent with PG behavior
