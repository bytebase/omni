...
**Spec:** `docs/specs/2026-04-09-partiql-parser-foundation-design.md` — read this first. It captures the 6 design decisions D1-D6, the stub audit, and the test strategy.
...
per docs/plans/2026-04-09-partiql-parser-foundation.md.
