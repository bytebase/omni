...
**Spec:** `docs/specs/2026-04-09-snowflake-splitter-design.md` (commit `f1e7d55`)
...
Plus the already-committed spec doc and plan doc at `docs/specs/2026-04-09-snowflake-splitter-design.md` and `docs/plans/2026-04-09-snowflake-splitter.md` (which will be tracked).
...
> - snowflake/parser/split.go
> - snowflake/parser/split_test.go
> - docs/plans/2026-04-09-snowflake-splitter.md (this plan)
>
