...
| 15a | parser-builtins-generic-call | `partiql/parser` (parser.go) | parser-foundation | parser-let-pivot, parser-window, parser-aggregates, parser-graph, parser-ion-literals, parser-datetime-literals, parser-builtins-typed | **P0** | done (omni commit ab96204) |
| 15b | parser-builtins-typed | `partiql/parser` (exprprimary.go, function.go) | parser-builtins-generic-call | parser-let-pivot, parser-window, parser-aggregates, parser-graph, parser-ion-literals, parser-datetime-literals | **P1** | in progress — 15b.1 SIZE/EXISTS done (omni commit 48421e9); remaining: CHAR_LENGTH/CHARACTER_LENGTH/OCTET_LENGTH/BIT_LENGTH/UPPER/LOWER, CAST family, CASE, SUBSTRING, TRIM, EXTRACT, COALESCE, NULLIF, DATE_ADD, DATE_DIFF, LIST/SEXP |
